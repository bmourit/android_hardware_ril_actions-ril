...
typedef enum {
    ...
    OEM_STRING,  /* oem_string for RIL_REQUEST_OEM_HOOK_STRINGS 
                    DTS2012022004973  lkf52201 2012-02-21 added */
} ATCommandType;
...
int at_send_command_string (const char *command,
                                 ATResponse **pp_outResponse);
...
typedef enum {
    ...
    CME_SIM_NOT_VALID =13,
    CME_PASSWORD_INCORRECT = 16    //ADD BY LIFEI KF34826 2010.11.19
} AT_CME_Error;
